...
const repos = {
  ...
  reposLength: 0,
  specificRepos: ["Face-Attendance","Flask-Application"],
};
...
const getInTouch = {
  ...
  message:
    "I'm currently looking for full-time job opportunity! If you know of any positions available,  or if you just wanna to say Hai, please feel free to email me at",
  email: "mailtoarunsoorya@gmail.com",
};
